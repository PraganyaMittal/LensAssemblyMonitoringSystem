...
namespace FactoryMonitoringWeb.Migrations
{
    ...
    [Migration("20260316052336_AddUpdateDeploymentColumns")]
    partial class AddUpdateDeploymentColumns
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FactoryMonitoringWeb.Models.UpdateDeployment", b =>
                {
            ...
            modelBuilder.Entity("FactoryMonitoringWeb.Models.UpdatePackage", b =>
                {
            ...
            modelBuilder.Entity("FactoryMonitoringWeb.Models.UpdateSchedule", b =>
                {
                    b.Property<int>("UpdateScheduleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FactoryMonitoringWeb.Models.YieldAlert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FactoryMonitoringWeb.Models.UpdateDeployment", b =>
                {
                    b.HasOne("FactoryMonitoringWeb.Models.AgentCommand", "AgentCommand")
                        .WithMany()
                    ...
                    b.HasOne("FactoryMonitoringWeb.Models.UpdateSchedule", "UpdateSchedule")
            ...
            modelBuilder.Entity("FactoryMonitoringWeb.Models.UpdateSchedule", b =>
                {
                    b.HasOne("FactoryMonitoringWeb.Models.FactoryMC", "HaltedAtMC")
                        .WithMany()
                        .HasForeignKey("HaltedAtMCId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("FactoryMonitoringWeb.Models.UpdateSchedule", "OriginalSchedule")
                        .WithMany()
                        .HasForeignKey("OriginalScheduleId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FactoryMonitoringWeb.Models.UpdatePackage", "UpdatePackage")
                        .WithMany()
