...
namespace LensAssemblyMonitoringWeb.Services
{
    ...
    public class LineDeploymentOrchestratorService : BackgroundService
    {
        ...
        private async Task ActivatePendingSchedulesAsync(
            LensAssemblyDbContext context, CancellationToken ct)
        {
            ...
            CancellationToken ct)
        {
            ...
            var mc = deployment.LensAssemblyMC;
            ...
            CancellationToken ct)
        {
            ...
            schedule.HaltReason = $"MC #{failedDeployment.LensAssemblyMC?.MCNumber} failed: "
            ...
            _logger.LogWarning(
                ...
                failedDeployment.LensAssemblyMC?.MCNumber,
                failedDeployment.LensAssemblyMC?.LineNumber,
                schedule.HaltReason);
