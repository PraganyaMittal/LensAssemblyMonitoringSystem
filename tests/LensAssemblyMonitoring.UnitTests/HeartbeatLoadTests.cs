...
namespace LensAssemblyMonitoring.UnitTests
{
    ...
    {
        private readonly Mock<ILensAssemblyMCRepository> _mockPcRepo;
        ...
        {
            _mockPcRepo = new Mock<ILensAssemblyMCRepository>();
        ...
        public async Task LoadTest_500ConcurrentHeartbeats_AllSucceed()
        {
            ...
            _mockPcRepo.Setup(r => r.GetByIdAsync(It.IsAny<int>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync((int id, CancellationToken ct) => new LensAssemblyMC
                {
                    MCId = id,
                    LineNumber = 1,
                    MCNumber = id,
            ...
            _mockPcRepo.Setup(r => r.UpdateAsync(It.IsAny<LensAssemblyMC>(), It.IsAny<CancellationToken>()))
        ...
        private LensAssemblyMonitoringWeb.Services.HeartbeatService CreateHeartbeatService()
        {
            ...
            return new LensAssemblyMonitoringWeb.Services.HeartbeatService(
                _mockPcRepo.Object,
                _mockCommandRepo.Object,
                Mock.Of<IModelRepository>(),
                Mock.Of<ILogger<LensAssemblyMonitoringWeb.Services.HeartbeatService>>(),
