...
namespace LensAssemblyMonitoring.UnitTests
{
    ...
    {
        private readonly Mock<ILensAssemblyMCRepository> _mockPCRepository;
        ...
        {
            _mockPCRepository = new Mock<ILensAssemblyMCRepository>();
        ...
        public async Task ProcessHeartbeatAsync_WithPendingCommands_ReturnsCommandsAndMarksInProgress()
        {
            ...
            var request = new HeartbeatRequest { MCId = 1, IsApplicationRunning = true };
            var existingPC = new LensAssemblyMC { MCId = 1 };
        ...
        public async Task ProcessHeartbeatAsync_RepositoryException_RethrowsAsIs()
        {
            ...
            var request = new HeartbeatRequest { MCId = 1, IsApplicationRunning = true };
            var repoException = new RepositoryException("LensAssemblyMC", "GetById", "DB timeout");
